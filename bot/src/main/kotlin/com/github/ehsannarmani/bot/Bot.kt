...
import com.github.ehsannarmani.bot.model.*
import com.github.ehsannarmani.bot.model.database.UserData
import com.github.ehsannarmani.bot.model.message.*
...
import com.github.ehsannarmani.bot.model.message.keyboard.reply.ReplyKeyboardItem
import com.github.ehsannarmani.bot.model.method.*
import com.github.ehsannarmani.bot.model.method.CallbackQuery
import com.github.ehsannarmani.bot.model.method.Game
import com.github.ehsannarmani.bot.model.method.Invoice
import com.github.ehsannarmani.bot.model.method.ShippingQuery
import com.github.ehsannarmani.bot.model.method.command.AddCommands
import com.github.ehsannarmani.bot.model.method.command.BotCommand
import com.github.ehsannarmani.bot.model.method.command.Commands
...
import com.github.ehsannarmani.bot.model.update.*
import com.github.ehsannarmani.bot.model.update.Photo
import com.github.ehsannarmani.bot.model.updating_messages.*
import com.github.ehsannarmani.bot.plugins.configureBot
...
class Bot(
     ...
     */
    suspend fun com.github.ehsannarmani.bot.model.update.CallbackQuery?.answer(
        text: String,
        alert: Boolean = false,
        url: String? = null
    ) {
     ...
     */
    suspend fun onInvoice(block: suspend (com.github.ehsannarmani.bot.model.update.Invoice) -> Unit) {
     ...
     */
    suspend fun onGame(block: suspend (com.github.ehsannarmani.bot.model.update.Game) -> Unit) {
     ...
     */
    suspend fun onCallbackQuery(block: suspend (com.github.ehsannarmani.bot.model.update.CallbackQuery) -> Unit) {
     ...
     */
    suspend fun onCallbackQuery(filter:String,block: suspend (com.github.ehsannarmani.bot.model.update.CallbackQuery) -> Unit) {
        if (lastUpdate?.callbackQuery != null) {
     ...
     */
    suspend fun InlineKeyboardItem.onCLick(onClick:suspend (com.github.ehsannarmani.bot.model.update.CallbackQuery)->Unit):InlineKeyboardItem{
        callbackData?.let {
            coroutineScope.launch {
    ...
    ): Result<com.github.ehsannarmani.bot.model.method.File>? {
        return callWithMap(
    ...
    inline fun <reified T> buildDBPath(): Bot.DBPath {
